                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-info ">
                        <div class="card-header">
                            ...
                            <a href="{{route('admin.permission.index')}}" class="btn btn-success btn-flat float-right">All Permissions</a>
                        </div>
                        @if ($errors->any())
                        ...
                        <form role="form" action="{{route('admin.permission.store')}}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="form-control"  placeholder="Permission Name">
                                </div>
                            </div>
